...
supply_demand=paste(my_runamc_folder, "SupplyDemand.xlsx", sep='')
supply_demand_2=paste(my_runamc_folder, "SupplyDemand_Original.xlsx", sep='')
...
results_files=list(m4_results_1,
                   m4_results_2)
make_taa_charts(output_path, results_files, weights, supply_demand_2)
